...
void demosaic_bgr_pattern(const T *bayer, T *output, std::size_t height, std::size_t width) {
    if (height < 3 || width < 3) {
...
void demosaic_bgr_impl(
    ...
    case BayerPattern::RGGB:
        demosaic_bgr_pattern<T, false, false>(bayer, output, height, width);
        break;
    case BayerPattern::GRBG:
        demosaic_bgr_pattern<T, false, true>(bayer, output, height, width);
        break;
    case BayerPattern::BGGR:
        demosaic_bgr_pattern<T, true, true>(bayer, output, height, width);
        break;
    case BayerPattern::GBRG:
        demosaic_bgr_pattern<T, true, false>(bayer, output, height, width);
        break;
    }
}
